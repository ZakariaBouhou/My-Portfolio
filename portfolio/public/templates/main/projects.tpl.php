<div class="all-projects" id="projects">
    ...
    <div class="projects-wrapper">
        <picture>
            <a href="#"><source srcset="../../assets/images/projets/lebonRecoin.PNG"
                media="(max-width: 767px)">
            <img src="../../assets/images/projets/lebonRecoinDesktop.PNG" alt=""></a>
        </picture>

        <picture>
            <a href="#"><source srcset="../../assets/images/projets/apex.PNG"
                media="(max-width: 767px)">
            <img src="../../assets/images/projets/apexDesktop.PNG" alt=""></a>
        </picture>

        <picture>
            <a href="#"><source srcset="../../assets/images/projets/caretheworld.PNG"
                media="(max-width: 767px)">
